...
*В ходе выполнения работы в код была добавленна возможность поддержки сразу нескольких профилей пользователей, для которых заметки сохраняються для каждого персонально*

### Практическая работа 12
*В ходе выполнения работы код был очищен от большого количества if/switch c помощью делегатов, а так же реализованно разделение использования __TodoList_ и _FileManager_ где было организованно взаимодействие через события*

## Семестр 2

### Практическая работа 1
*В ходе выполнения работы в код была добавленна команда _search_ а так же программа быыла обновлена с учетом нового изученого материала*